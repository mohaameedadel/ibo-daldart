...
import dermatologyVideoThumbnail from '../../../../public/images/specialities/dermatologyimage.svg';

const DermatologyAestheticsSection = () => {
  ...
  return (
    <section className="container bg-white overflow-hidden py-8 md:py-16">
      <div className="mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:max-w-[650px] text-center md:text-left order-1 md:order-2">
          ...
          <p className="text-[#828282] text-[16px] md:text-[16px] leading-[24px] mt-4">
            ...
            At fermentum nisl ullamcorper orci. Pellentesque id tempor lacus aliquet tempus vitae nibh
        ...
        {/* Video Block */}
        <div className="relative w-full md:w-[636px] h-[300px] md:h-[480px] rounded-lg overflow-hidden order-2 md:order-1">
          <Image
            src={dermatologyVideoThumbnail}
            alt="Dermatology Video Thumbnail"
            layout="fill"
            objectFit="cover"
      ...
      {isVideoOpen && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="relative w-[90%] md:w-[70%] max-w-[960px]">
            ...
            >
              <source src="/videos/dermatology-video.mp4" type="video/mp4" />
...
export default DermatologyAestheticsSection;
